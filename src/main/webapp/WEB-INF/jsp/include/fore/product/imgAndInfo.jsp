                ...
                function(resultInfo){
                    if(resultInfo.flag){
                        ...
                        $.get(
                                ...
                                function(resultInfo){
                                    if(resultInfo.flag){
                                        alert(resultInfo.data.msg);
                                        var number = parseInt($("#cartNumber").text());
                                        var n = Number(num);
                                        $("#cartNumber").text(n + number);
                                    }
                                    else{
        ...
        $.get(
                ...
                function(resultInfo){
                    if(resultInfo.flag){
                        ...
                        $("span.errorMessage").html(resultInfo.data.msg);
                        $("div.loginErrorMessageDiv").show();                       
                    }
                }
        );          
...
<div class="imgAndInfo">
    ...
    <div class="infoInimgAndInfo">
        ...
        <div class="buyDiv">
            <a class="buyLink" href="forebuyNow?pid=${p.id}"><button class="buyButton">立即购买</button></a>
